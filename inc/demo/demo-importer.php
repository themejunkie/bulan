...
add_filter( 'pt-ocdi/import_files', 'bulan_import_files' );

/**
 * After import function
 */
function bulan_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'bulan_after_import_setup' );
