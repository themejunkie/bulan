...
function bulan_customizer_menu_styles() {
	...
	$dropdown = bulan_mod( $prefix . 'menu-dropdown-hover-bgcolor' );

	if ( $dropdown !== customizer_library_get_default( $prefix . 'menu-dropdown-hover-bgcolor' ) ) {

		$color = sanitize_hex_color( $dropdown );
